...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/git-remote-s3-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/git-remote-s3-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add git-remote-s3
# for installing globally
pixi global install git-remote-s3
```
...
It is possible to list all of the versions of `git-remote-s3` available on your platform:
...
```
pixi search git-remote-s3 --channel conda-forge
```
